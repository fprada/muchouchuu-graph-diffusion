...
DS_FILE = (
    "muchouchuu_step6_window7_s64_plateau_tmin3584/"
    "spectral_dimension_sliding_bootstrap.csv"
)

PK_PROXY_FILE = "muchouchuu_diffusion_pk_proxy.csv"
...
RHOM_OBS = 446.3
RHOM_OBS_LO = 446.3 - 27.7
RHOM_OBS_HI = 446.3 + 41.7
...
comparison.to_csv(
    "muchouchuu_ds_pk_prediction_comparison.csv",
    index=False
)
...
fig.savefig(
    "muchouchuu_ds_pk_prediction.png",
    dpi=220
)
