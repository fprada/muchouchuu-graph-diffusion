#!/usr/bin/env python3
"""Create the main-paper MuchoUchuu 64-probe Euclidean-persistence figure.
...
COLUMN_ALIASES = {
    ...
    "q16": (
        "bootstrap_q16", "bootstrap_ds_q16", "q16", "ds_q16", "spectral_dimension_q16",
        "lower_68", "lower68",
    ),
    "q84": (
        "bootstrap_q84", "bootstrap_ds_q84", "q84", "ds_q84", "spectral_dimension_q84",
        "upper_68", "upper68",
    ),
}
...
def make_figure(
    ...
    ax1.set_title("Euclidean transport from 64 independent probes")
    ...
    ax2.text(
        ...
        r"persistent Euclidean regime beyond $R_{\rm hom}$",
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path("muchouchuu_euclidean_persistence_paper_v2.png"),
    )
    parser.add_argument(
        "--output-pdf", type=Path,
        default=Path("muchouchuu_euclidean_persistence_paper_v2.pdf"),
    )
