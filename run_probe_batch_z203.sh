...
GRAPH="$ROOT/growth_test/z203/muchouchuu_graphs_block_parallel/knn_periodic.npz"
XYZ="$ROOT/growth_test/z203/muchouchuu_xyz_f32.bin"
FINALROOT="$ROOT/growth_test/z203/trace_batches"

LOCALDISK="${LOCALDISK:?Set LOCALDISK to the node-local filesystem}"

BATCH=$(printf "batch_%02d" "$BATCH_NUMBER")
LOCALROOT="$LOCALDISK/fprada_muchouchuu_z203_${BATCH}"
