...
sigma_fit = sigma_ds[fit]
w = 1.0 / sigma_fit**2

C = np.sum(w * x * y) / np.sum(w * x * x)
C_sigma_formal = np.sqrt(1.0 / np.sum(w * x * x))
...
print("C                    :", f"{C:.8e}")
print("formal sigma(C)      :", f"{C_sigma_formal:.8e}")
print("fit RMSE             :", f"{rmse:.8e}")
print("fit R^2              :", f"{R2:.6f}")
print("chi2                  :", f"{chi2:.6f}")
print("dof                   :", dof)
print("reduced chi2          :", f"{chi2_red:.6f}")
