...
XYZ="gaussian_pk_control_seed1001/grf_displaced_N108000000_xyz_f32.bin"
GRAPH="gaussian_pk_control_seed1001/grf_graphs/knn_periodic.npz"
GMETA="gaussian_pk_control_seed1001/grf_graphs/parameters.json"

STATE="gaussian_pk_control_seed1001/grf_trace_batches/batch_02_state"
TRACE="gaussian_pk_control_seed1001/grf_trace_batches/batch_02_trace"
