...
ax.plot(
    [RHOM2_Q16, RHOM2_Q84],
    [y_indicator - 0.012, y_indicator - 0.012],
    color=line2.get_color(),
    linewidth=2.2,
    solid_capstyle="round",
)
...
OUT_PNG = (
    "figure_z0_z103_z203_ds_physical_scale_pub.png"
)

OUT_PDF = (
    "figure_z0_z103_z203_ds_physical_scale_pub.pdf"
)
